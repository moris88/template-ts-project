...
export namespace TestGraphic {
    export function main() {
        ...
        Graphic.inserisciRecord(tableTag.elementID, [
            '1',
            'Maurizio',
            'Tolomeo',
        ])
        ...
        Graphic.inserisciOpzione(selectTag.elementID, 'maschio', 'm', false)
        Graphic.inserisciOpzione(selectTag.elementID, 'femmina', 'f', true)
